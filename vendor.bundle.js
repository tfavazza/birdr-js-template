...
/***/ function(module, exports) {
	...
	var app = {
	  host: 'https://warm-brushlands-74801.herokuapp.com'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showTweetSuccess = function showTweetSuccess(data) {
	  anySuccess();
	  $('.tweets').text('');
	  app.user = data.user;
	  //console.log("app.user is " + app.user);
	  var tweets = app.user.tweets;
	  //console.log(tweets);
	  for (var i = tweets.length - 1; i > -1; i--) {
	    // $('.tweets').append(app.user.email + ": " + app.user.tweets[i].content + '<br>');
	    var allTweets = __webpack_require__(8);
	    $('.tweets').append(allTweets(app.user.tweets[i]));
	  }
	};

	var showMyTweetsSuccess = function showMyTweetsSuccess(data) {
	  anySuccess();
	  $('.tweets').text('');
	  //console.log(data);
	  var tweets = data.user.tweets;
	  //console.log(tweets);
	  for (var i = tweets.length - 1; i > -1; i--) {
	    var allTweets = __webpack_require__(8);
	...
	var sendTweetSuccess = function sendTweetSuccess(data) {
	  anySuccess();
	  //console.log(data);
	...
	var showTimelineTweetsSucccess = function showTimelineTweetsSucccess(data) {
	  anySuccess();
	  app.tweets = data.tweets;
	  $('.tweets').text(' ');
	  for (var i = app.tweets.length - 1; i > -1; i--) {
	    // $('.tweets').append(app.user.email + ": " + app.user.tweets[i].content + '<br>');
	    var allTweets = __webpack_require__(8);
	...
	*/
	...
	module.exports = {
	  ...
	  showTweetSuccess: showTweetSuccess,
	  sendTweetSuccess: sendTweetSuccess,
	  showTimelineTweetsSucccess: showTimelineTweetsSucccess,
	  signUpSuccess: signUpSuccess,
	  showMyTweetsSuccess: showMyTweetsSuccess,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var content = '';
	var getTweetText = function getTweetText() {
	  content = $('#input-custom-size').val();
	};

	var makeTweetData = function makeTweetData() {
	...
	var displayUser = function displayUser(tweet) {
	  $('.timeline').append("here is that user: " + tweet + "</br>");
	};

	var displayTweets = function displayTweets(tweet) {
	...
	var collectTweetData = function collectTweetData(tweetArray) {
	...
	module.exports = {
	  ...
	  makeTweetData: makeTweetData,
	  getTweetText: getTweetText,
	  collectTweetData: collectTweetData
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
